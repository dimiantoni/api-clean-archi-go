...
import (
	entity "github.com/dimiantoni/api-clean-archi-go/domain/entity"
...
func (m *MockUseCase) CreateUser(name, email, password, address string, age int8) (entity.ID, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateUser", name, email, password, address, age)
	ret0, _ := ret[0].(entity.ID)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUseCaseMockRecorder) CreateUser(name, email, password, address, age interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateUser", reflect.TypeOf((*MockUseCase)(nil).CreateUser), name, email, password, address, age)
}
